...
import ir.hatamiarash.network_discovery.Network.HostBean;
import ir.hatamiarash.network_discovery.Network.NetInfo;
import ir.hatamiarash.network_discovery.Utils.Export;
import ir.hatamiarash.network_discovery.Utils.Help;
import ir.hatamiarash.network_discovery.Utils.Prefs;
import ir.hatamiarash.network_discovery.Utils.Save;
...
final public class ActivityDiscovery extends ActivityNet implements OnItemClickListener {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which) {
                    ...
                    case 1:
                        ...
                        final AlertDialog.Builder rename = new AlertDialog.Builder(ActivityDiscovery.this);
                        rename.setView(v);
    ...
    private class HostsAdapter extends ArrayAdapter<Void> {
        private HostsAdapter(Context ctxt) {
