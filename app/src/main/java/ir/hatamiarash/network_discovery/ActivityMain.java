...
package ir.hatamiarash.network_discovery;
...
import ir.hatamiarash.network_discovery.Network.NetInfo;
import ir.hatamiarash.network_discovery.Utils.Db;
import ir.hatamiarash.network_discovery.Utils.DbUpdate;
import ir.hatamiarash.network_discovery.Utils.Prefs;

final public class ActivityMain extends Activity {
    public final static String TAG = ActivityMain.class.getSimpleName();
    public static final String PKG = "ir.hatamiarash.network_discovery";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        edit.putString(Prefs.KEY_INTF, Prefs.DEFAULT_INTF).apply();
        phase2(getApplicationContext());
    }
    ...
    private static class CreateServicesDb extends AsyncTask<Void, String, Void> {
        private WeakReference<Activity> mActivity;
        private ProgressDialog progress;
        
        private CreateServicesDb(Activity activity) {
